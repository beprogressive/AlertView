...
abstract class SlidingActivityExtended : AppCompatActivity(), SlidingInstance {
...
//        val outMetrics = DisplayMetrics()
        ...
        currentBounds = windowMetrics.bounds // E.g. [0 0 1350 1800]
...
//        displayMetrics = outMetrics
    ...
    override fun dispatchTouchEvent(ev: MotionEvent): Boolean {
        ...
        if (root == null) {
            log("getSlidingContainer() must not be null!")
